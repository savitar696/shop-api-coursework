import { Controller, Post, Body, UseGuards, Get, Param, Inject, ParseIntPipe, HttpCode, HttpStatus } from '@nestjs/common';
...
import { ApiTags, ApiOperation, ApiResponse, ApiBody, ApiBearerAuth, ApiParam, ApiProperty } from '@nestjs/swagger';
...
export class ReviewController {
  ...
  @ApiResponse({ status: 200, description: 'Список отзывов', type: [ReviewDto] })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
